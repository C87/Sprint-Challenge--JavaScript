...
for (let i = 0; i < graduates.length; i ++) {
  graduates[i].university.includes('Uni') ? uni.push(graduates[i].university) : false;
}
...
*/
const largerPopulation = zooAnimals.filter(animal => animal.population < 5 ? zooAnimals : false);
